...
$stmt = $pdo->query("SELECT * FROM portfolio WHERE development_type = 'ai' ORDER BY id DESC");
                    ...
                    <div class="row">
                        ...
                        <div class="card w-100 p-0">
                            <div class="card-header">
                                <h3 class="card-title" style="display:flex; align-items:center;">AI Lists<a
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <a href="ai-edit.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">
                                                Edit
                                                </a>
...
function deleteRecord(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "ai-delete.php?id=" + id;
        }
...
Swal.fire({
    ...
    window.history.replaceState({}, document.title, "ai-list.php");
});
</script>
