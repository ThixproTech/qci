...
$image2 = uploadImage("image2", $uploadDir, $oldImage2);
$image3 = uploadImage("image3", $uploadDir, $oldImage3);
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Web Development Edit</h4>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 form-group mb-3">
                                        <label>AMC</label>
                                        <input type="text" name="amc" class="form-control" value="<?= htmlspecialchars($row['amc']); ?>" required
