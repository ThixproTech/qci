...
if(isset($_POST['Submit'])){
    ...
    (heading, development_type, url, image1, image2, image3, description)
    VALUES
    (:heading, :development_type, :url, :image1, :image2, :image3, :description)";
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Game Development Add</h4>
...
Swal.fire({
    ...
    window.location.href = "game-list.php";
});
</script>
